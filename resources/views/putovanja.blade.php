...
@section('title','Turisticka Agencija')
...
@section('content')
    ...
    <div class="container">
        <div class="title">
          <h1><Strong>Tourist Agency</strong></h1>
        </div>
        ...
        @foreach($putovanja as $putovanje)
          <li>
            ...
            <div class="hotel-name"><a href="{{$putovanje->id}}">{{$putovanje->destinacija}}</a></div>
            <div class="info">{{$putovanje->trajanje}}</div>
            <div class="btn" name="select" type="select" id="select-hotel" data-submit="...Sending"><a href="{{$putovanje->id}}">See More</a></div>
          </li>
          @endforeach
        </ul>
      </div>
